/* create a visualisation that provides a breakdown
between the male and female employees working in the same company each year,
starting from 1990 */
...
/* compare the average salary of female vs male employees
in the entir company until year 2002, and add a filter
...
this range be defined by two values the user can insert when calling the procedure*/
